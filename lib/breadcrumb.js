...
var enrichRouteObject = function(path, isCurrent) {
    ...
    var title = Router.routes[path].options.hasOwnProperty('title') ? Router.routes[path].options.title : Router.options.title;
    if (typeof title === 'function') {
      title = _.bind(title, Router.routes[path])();
    }
...
var getAllParents = function() {
    if(Router.current().route) {
      ...
      if (typeof parent === 'function') {
        parent = _.bind(parent, Router.current().route)();
      }
      if(parent) {
